...
class MemoryAbstraction
{
  ...
  public:
     ...
     **/
    MemoryAbstraction(size_t size, MPI_Datatype type, int dimensions);
     ...
     * program.
     **/
    virtual void store(void *base_ptr, void *value_ptr, std::vector<size_t> indices);
     ...
     * program.
     **/
    virtual void load(void *base_ptr, void *dest_ptr, std::vector<size_t> indices);
     ...
     **/
    virtual void sequential_store(void *base_ptr, void *value_ptr, std::vector<size_t> indices);
     ...
     * this is a synchronous operation between all processes.
     **/
    virtual void sequential_load(void *base_ptr, void *dest_ptr, std::vector<size_t> indices);

    /**
     * A pointer store to an MemoryAbstraction with pointer depth >= 2.
     **/
    virtual void pointer_store(void *source_ptr, size_t dest_index);
