...
// RUN: diff <(mpirun -np 5 %t_modified.x) %s.reference_output
#include <stdio.h>
#include <stdlib.h>
#include <omp.h>
...
int main()
{
    ...
    int* matrix = malloc(sizeof(int)*2*3*2*3);
    ...
    M[0][1][1] = matrix + 3*3;
    M[0][2][0] = matrix + 3*3 + 3;
    M[0][2][1] = matrix + 3*3 + 3*2;

    M[1][0][0] = matrix + 3*3 + 3*3;
    M[1][0][1] = matrix + 3*3 + 3*3 + 3;
    M[1][1][0] = matrix + 3*3 + 3*3 + 3*2;

    M[1][1][1] = matrix + 3*3*3;
    M[1][2][0] = matrix + 3*3*3 + 3;
    M[1][2][1] = matrix + 3*3*3 + 3*2;
