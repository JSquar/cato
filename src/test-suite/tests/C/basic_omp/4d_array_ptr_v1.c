...
int main()
{
    ...
    M[0][0][0] = (int*)malloc(sizeof(int)*2);
    M[0][0][1] = (int*)malloc(sizeof(int)*2);
    M[0][1][0] = (int*)malloc(sizeof(int)*2);
    M[0][1][1] = (int*)malloc(sizeof(int)*2);
    M[1][0][0] = (int*)malloc(sizeof(int)*2);
    M[1][0][1] = (int*)malloc(sizeof(int)*2);
    M[1][1][0] = (int*)malloc(sizeof(int)*2);
    M[1][1][1] = (int*)malloc(sizeof(int)*2);
